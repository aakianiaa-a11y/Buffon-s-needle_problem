...
Buffon's needle problem is a foundational question in geometric probability. Consider a plane ruled with parallel lines spaced uniformly at distance \( t \). A needle of length \( l \) (with \( l \leq t \)) is dropped randomly. What is the probability \( P \) that the needle crosses one of the lines? The elegant answer is:
